...
/**
 * Lightweight PNG check for paths where we've already established the
 * source is a data: URL with `image/png` MIME (signatures). The full
 * validateUpload() flow expects a client-supplied content-type string;
 * here we just need to confirm the decoded bytes really are a PNG.
 *
 * Sebastian's 2026-05-16 audit, finding L3.
 */
